...
public class ReviewRestController {
    ...
    public ResponseEntity<Review> actualizar(@PathVariable Long id, @RequestBody Review reviewActualizada) {
        ...
        // 1. Buscamos si la review existe en la BD
        ...
        // 2. Actualizamos los campos con los valores recibidos
        ...
        // 3. Guardamos la review actualizada
        Review guardada = reviewService.guardar(existente);

        // 4. Devolvemos 200 OK con la review actualizada
